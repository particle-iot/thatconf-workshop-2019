...
| **Tools you’ll need**       | A Particle Argon, USB Cable, the Particle mobile app for iOS or Android.                |
...
You will now flash firmware  from the [Particle Web IDE](https://build.particle.io/build/)
